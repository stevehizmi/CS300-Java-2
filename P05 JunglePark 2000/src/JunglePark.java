...
public class JunglePark extends PApplet {
	...
	public void setup() {
		...
		// window
		listGUI.add(new AddAnimalButton("deer",129,16,this));//adds deer button
		listGUI.add(new AddAnimalButton("tiger",43,16,this));//adds tiger button
		listGUI.add(new ClearButton(215,16,this));//adds clear button
	}
